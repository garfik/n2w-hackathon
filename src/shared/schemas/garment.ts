...
export const GarmentProfileSchema = z.object({
  category: z.enum(["dress","top","shirt","jacket","coat","pants","jeans","skirt","shorts","shoes","other"]),
  ...
  material_guess: z.enum(["denim","knit","cotton","wool","leather","synthetic","other","unknown"]),
